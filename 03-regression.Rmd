...
This is a **simple linear regression model**. It is the foundation of many statistical models used is modern statistics and is more flexible than you may think. 
...
If you want to get a sense of what the number -0.232 means, we need to do a bit of algebra. Our estimated model is
...
We find that $e^{-0.232} = 0.793$ is the **odds ratio** based on increasing x by 1 unit. If a ratio is less than 1, that means that the denominator is greater than the numberator. In this case, it means that the estimated odds of o-ring failure decreases as you increase temperature by 1 degree. This makes sense since we saw that the chance of o-ring failure increases with colder temperatures. 
