...
- Each row of a rectangular table corresponds to an **observation** or **unit** (e.g. person, classroom, country, image, word) 
- Each column correspond to a characteristic or feature or **variable** for those units (e.g. age, average classroom grade, average county income, intensity of red pixels, number of times the word "together" is used)
