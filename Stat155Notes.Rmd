...
<!--chapter:end:04-logistic-regression.Rmd-->
...
<!--chapter:end:05-variability.Rmd-->
...
```{r setup_definitions, echo=FALSE}
library(stringr)
library(infer)
library(nycflights13)
library(broom)
