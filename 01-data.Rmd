...
```{r echo=FALSE}
files <- list.files("./Data/sotu")
fileName <- glue("./Data/sotu/", files[209], sep = "")
...
1. Any observed data is a sample of a larger population or phenomenon. But you need to consider which population. Is it the population of interest? If not, then why?
...
3. Study design impacts what type of conclusions we can make. Confounding variables prevent us from making cause and effect conclusions. 

4. We need to be aware of the real consequences of our choices when working with data and building models.