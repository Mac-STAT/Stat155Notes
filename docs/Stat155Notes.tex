...
\NormalTok{body }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{summarize}\NormalTok{(}
      \DataTypeTok{sy =} \KeywordTok{sd}\NormalTok{(Chest), }
      \DataTypeTok{sx =} \KeywordTok{sd}\NormalTok{(Neck), }
      \DataTypeTok{r =} \KeywordTok{cor}\NormalTok{(Chest,Neck), }
      \DataTypeTok{ybar =} \KeywordTok{mean}\NormalTok{(Chest), }
      \DataTypeTok{xbar =} \KeywordTok{mean}\NormalTok{(Neck)) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}
      \DataTypeTok{beta1 =}\NormalTok{ r}\OperatorTok{*}\NormalTok{sy}\OperatorTok{/}\NormalTok{sx, }
      \DataTypeTok{beta0 =}\NormalTok{ ybar }\OperatorTok{-}\StringTok{ }\NormalTok{beta1}\OperatorTok{*}\NormalTok{xbar) }\OperatorTok{%>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tshirt_mod <-}\StringTok{ }\NormalTok{body }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{with}\NormalTok{(}\KeywordTok{lm}\NormalTok{(Chest }\OperatorTok{~}\StringTok{ }\NormalTok{Neck))}

\NormalTok{tshirt_mod }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{body <-}\StringTok{ }\NormalTok{body }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{CNeck =}\NormalTok{ Neck }\OperatorTok{-}\StringTok{ }\KeywordTok{mean}\NormalTok{(Neck))}

\NormalTok{tshirt_mod2 <-}\StringTok{ }\NormalTok{body }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{with}\NormalTok{(}\KeywordTok{lm}\NormalTok{(Chest }\OperatorTok{~}\StringTok{ }\NormalTok{CNeck))}
       
\NormalTok{tshirt_mod2 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\StringTok{    }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method =} \StringTok{'lm'}\NormalTok{, }\DataTypeTok{se =} \OtherTok{FALSE}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{'High School GPA'}\NormalTok{, }\DataTypeTok{y =} \StringTok{'College GPA'}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{theme_classic}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{with}\NormalTok{(}\KeywordTok{lm}\NormalTok{(univ_GPA }\OperatorTok{~}\StringTok{ }\NormalTok{high_GPA))}
...
\NormalTok{sat }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}
    \KeywordTok{sd}\NormalTok{(univ_GPA), }
    \DecValTok{2}\OperatorTok{*}\KeywordTok{sd}\NormalTok{(univ_GPA))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{SSTO <-}\StringTok{ }\NormalTok{sat }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{SSTO =} \KeywordTok{sum}\NormalTok{((univ_GPA }\OperatorTok{-}\StringTok{ }\KeywordTok{mean}\NormalTok{(univ_GPA))}\OperatorTok{^}\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}
...
\begin{Highlighting}[]
\NormalTok{dat }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(x }\OperatorTok{<}\StringTok{ }\DecValTok{15} \OperatorTok{&}\StringTok{ }\NormalTok{y }\OperatorTok{<}\StringTok{ }\DecValTok{5}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\CommentTok{#filter out outliers}
...
\NormalTok{gapminder }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(year }\OperatorTok{>}\StringTok{ }\DecValTok{2005}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{TgdpPercap =} \DecValTok{-1}\OperatorTok{/}\NormalTok{gdpPercap) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ lifeExp, }\DataTypeTok{x =}\NormalTok{  TgdpPercap)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{theme_classic}\NormalTok{()}
\end{Highlighting}
...
\NormalTok{lm.gap }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{dat }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{with}\NormalTok{(}\KeywordTok{lm}\NormalTok{(y }\OperatorTok{~}\StringTok{ }\KeywordTok{poly}\NormalTok{(x, }\DataTypeTok{degree =} \DecValTok{2}\NormalTok{, }\DataTypeTok{raw =} \OtherTok{TRUE}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lm.home <-}\StringTok{ }\NormalTok{homes }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{with}\NormalTok{(}\KeywordTok{lm}\NormalTok{(Price }\OperatorTok{~}\StringTok{ }\NormalTok{AnyFireplace))}

\NormalTok{lm.home }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lm.home2 <-}\StringTok{ }\NormalTok{homes }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{with}\NormalTok{(}\KeywordTok{lm}\NormalTok{(Price }\OperatorTok{~}\StringTok{ }\NormalTok{AnyFireplace }\OperatorTok{+}\StringTok{ }\NormalTok{Living.Area))}

\NormalTok{lm.home2 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lm.home2 }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{augment}\NormalTok{() }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Living.Area, }\DataTypeTok{color =}\NormalTok{ AnyFireplace)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom_point}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ Price)) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ .fitted)) }\OperatorTok{+}
\StringTok{    }\KeywordTok{theme_classic}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lm.home3 <-}\StringTok{ }\NormalTok{homes }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{with}\NormalTok{(}\KeywordTok{lm}\NormalTok{(Price }\OperatorTok{~}\StringTok{ }\NormalTok{AnyFireplace}\OperatorTok{*}\NormalTok{Living.Area))}

\NormalTok{lm.home3 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lm.home3 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{boot <-}\StringTok{ }\KeywordTok{do}\NormalTok{(}\DecValTok{1000}\NormalTok{)}\OperatorTok{*}\NormalTok{(}
\NormalTok{    homes }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{sample_frac}\NormalTok{(}\DataTypeTok{replace =} \OtherTok{TRUE}\NormalTok{) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{with}\NormalTok{(}\KeywordTok{lm}\NormalTok{(Price }\OperatorTok{~}\StringTok{ }\NormalTok{Living.Area}\OperatorTok{*}\NormalTok{AnyFireplace))}
\NormalTok{)}
...
\StringTok{    }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{'Bootstrap Difference in Slopes'}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{theme_classic}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{boot }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\KeywordTok{sd}\NormalTok{(Living.Area.AnyFireplaceTRUE)) }
\end{Highlighting}
\end{Shaded}
...
\NormalTok{boot }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}
    \DataTypeTok{lower =} \KeywordTok{quantile}\NormalTok{(Living.Area.AnyFireplaceTRUE, }\FloatTok{0.025}\NormalTok{), }
    \DataTypeTok{upper =} \KeywordTok{quantile}\NormalTok{(Living.Area.AnyFireplaceTRUE, }\FloatTok{0.975}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lm.home4 <-}\StringTok{ }\NormalTok{homes }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{with}\NormalTok{( }\KeywordTok{lm}\NormalTok{(Price }\OperatorTok{~}\StringTok{ }\NormalTok{Living.Area }\OperatorTok{+}\StringTok{ }\NormalTok{Bedrooms }\OperatorTok{+}\StringTok{ }\NormalTok{Bathrooms }\OperatorTok{+}\StringTok{ }\NormalTok{Rooms))}

\NormalTok{lm.home4 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lm.home5 <-}\StringTok{ }\NormalTok{homes }\OperatorTok{%>%}\StringTok{ }
...
\NormalTok{lm.home5 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
