...
**Gut Check:** Does our data suggest that smoking *is associated* with a lower mortality rate?  Does our data suggest that smoking *reduces* mortality? (Note the difference in these two questions - the second implies a cause and effect relationship.)
...
Our primary interest is the `wage` variable which gives the wage. What is the relationship between years of education and hourly wage?
