...
\hypersetup{
  ...
  pdfauthor={Macalester Statistics Faculty},
  hidelinks,
...
\NormalTok{ceo }\SpecialCharTok{\%\textgreater{}\%}
    ...
    \FunctionTok{geom\_histogram}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ ..density..), }\AttributeTok{binwidth =} \DecValTok{5}\NormalTok{, }\AttributeTok{fill =} \StringTok{"steelblue"}\NormalTok{) }\SpecialCharTok{+} 
    \FunctionTok{geom\_density}\NormalTok{(}\AttributeTok{alpha =} \FloatTok{0.2}\NormalTok{, }\AttributeTok{fill =} \StringTok{"steelblue"}\NormalTok{) }\SpecialCharTok{+} 
    \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{\textquotesingle{}Salary ($ Millions)\textquotesingle{}}\NormalTok{, }\AttributeTok{y =} \StringTok{\textquotesingle{}Density\textquotesingle{}}\NormalTok{) }\SpecialCharTok{+} 
    \FunctionTok{theme\_classic}\NormalTok{() }
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{ceo }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ salary)) }\SpecialCharTok{+}
    \FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+} 
    \FunctionTok{ylab}\NormalTok{(}\StringTok{\textquotesingle{}Salary ($M)\textquotesingle{}}\NormalTok{) }\SpecialCharTok{+} 
    \FunctionTok{theme\_classic}\NormalTok{() }
\end{Highlighting}
\end{Shaded}
...
\NormalTok{body }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Neck, }\AttributeTok{y =}\NormalTok{ Chest)) }\SpecialCharTok{+}
    \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{color =} \StringTok{\textquotesingle{}steelblue\textquotesingle{}}\NormalTok{) }\SpecialCharTok{+} 
    \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept =} \FunctionTok{mean}\NormalTok{(body}\SpecialCharTok{$}\NormalTok{Chest)) }\SpecialCharTok{+}
    \FunctionTok{geom\_vline}\NormalTok{(}\AttributeTok{xintercept =} \FunctionTok{mean}\NormalTok{(body}\SpecialCharTok{$}\NormalTok{Neck)) }\SpecialCharTok{+}
    \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{\textquotesingle{}Neck size (cm)\textquotesingle{}}\NormalTok{, }\AttributeTok{y =} \StringTok{\textquotesingle{}Chest size (cm)\textquotesingle{}}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{theme\_classic}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{flights\_samp }\OtherTok{\textless{}{-}}\NormalTok{ flights\_samp }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{afternoon =}\NormalTok{ flights\_samp}\SpecialCharTok{$}\NormalTok{day\_hour }\SpecialCharTok{==} \StringTok{\textquotesingle{}afternoon\textquotesingle{}}\NormalTok{)}

\NormalTok{glm.afternoon }\OtherTok{\textless{}{-}}\NormalTok{ flights\_samp }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{with}\NormalTok{(}\FunctionTok{glm}\NormalTok{(afternoon }\SpecialCharTok{\textasciitilde{}}\NormalTok{ season, }\AttributeTok{family =} \StringTok{\textquotesingle{}binomial\textquotesingle{}}\NormalTok{))}

\NormalTok{glm.afternoon }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{07-inference_files/figure-latex/unnamed-chunk-29-1} \end{center}
...
\NormalTok{cv.err }\OtherTok{\textless{}{-}} \FunctionTok{cv.glm}\NormalTok{(data,glm1, }\AttributeTok{K =} \DecValTok{5}\NormalTok{)}
\FunctionTok{sqrt}\NormalTok{(cv.err}\SpecialCharTok{$}\NormalTok{delta[}\DecValTok{1}\NormalTok{]) }\CommentTok{\#out of sample average prediction error}
\end{Highlighting}
\end{Shaded}
